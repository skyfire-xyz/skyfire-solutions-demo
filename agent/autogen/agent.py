...
async def run_agent() -> None:
    ...
    agent = AssistantAgent(
        ...
        system_message="You are a helpful e-commerce buyer agent assisting user to make a purchase. Whenever there is a need to create an account, use 123456S$d#d as the password. Do not truncate or mutate tokens. IMPORTANT: Do not assume dataset URLs and pricing."
