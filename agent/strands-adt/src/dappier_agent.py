...
{additional_context}
Remember to call the decode_jwt_token tool immediately after you recieve jwts. Do not truncate or mutate tokens.
...
class DappierStrandsAgent(Agent):
    """
    Dappier Agent that inherits from strands Agent.
