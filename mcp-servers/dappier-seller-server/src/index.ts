...
const accessControl = new McpAccessControl({
  ...
  audience: env.DAPPIER_SELLER_ID,
...
export class MyMCP extends McpAgent<Bindings, State> {
    ...
    data: [
      {
        ...
        dataUrl:
          "https://pub-303d212fa4df4073b8b38b3de4a72d89.r2.dev/Dappier/demo-dataset1.csv",
      },
      {
        id: 2,
        dataId: 2,
        ...
        dataUrl:
          "https://pub-303d212fa4df4073b8b38b3de4a72d89.r2.dev/Dappier/demo-dataset2.csv",
      },
    ],
  };
  ...
  async init() {
    this.server.tool(
      ...
      On successful account creation, access token is returned`,
      {
        kya_token: z
          .string()
          .describe(
            "KYA token generated by Skyfire to be used by Dappier for account creation"
          ),
      ...
      async ({ kya_token, password }) => {
        return createAccountAndLoginWithOry(kya_token, password);
      }
    );
    ...
    this.server.tool(
      ...
      this.withAuth(async ({ access_token }) => {
    ...
    this.server.tool(
      ...
      this.withAuth(async ({ access_token, dataset_id }) => {
    ...
    this.server.tool(
      ...
      this.withAuth(async ({ access_token, dataset_id, pay_token }) => {
...
app.get("/", async (c) => {
  return c.html("Home Page for Dappier Seller MCP Server");
});
